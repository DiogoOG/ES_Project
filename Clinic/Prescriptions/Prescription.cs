...
namespace Clinic
{
    ...
    public class Prescription : Entity<int>
    {
        ...
        private List<int> _permissions = new List<int>();   // List of those that have access permissions (if private)
        ...
        public List<int> Permissions { get => _permissions; }
        ...
        public override string ToString() {
            string permissions="";
            foreach(int p in _permissions)
            {
                permissions += p.ToString() + ";";
            }
            return $"{IDPatient},{IDTherapist},{Prescriptionable.Type},{Prescriptionable.Name},{Visibility},{Schedule},{permissions}";
        }
    }
}
